...
Nunca execute ou teste os scripts diretamente na sua máquina de uso diário. Baixe o código localmente (usando it clone https://github.com/arthur-aida/zorin_corporate_configs.git) ou use as extensões de segurança do próprio GitHub e pesquise como sanitizar o código com os recursos a seguir:
