...
11-Leia as orientações do item 12-. Opcionalmente para otimitizar o processo acima, abra o terminal em uma VM, copie e cole o texto abaixo para executar os processos acima de forma automatizada:
