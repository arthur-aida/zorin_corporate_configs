...
11-Leia as orientações do item 12-. Opcionalmente para otimitizar o processo acima em uma VM, abra no navegador o site do github e pesquise pelos  termos "corporativo token smartcard" e copie e cole no terminal o texto abaixo para executar os processos acima de forma automatizada:
...
Nunca execute ou teste os scripts diretamente na sua máquina de uso diário. Baixe o código localmente (usando git clone) ou use as extensões de segurança do próprio GitHub e pesquise como sanitizar o código com os recursos a seguir:
