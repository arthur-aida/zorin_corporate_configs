...
11-Leia as orientações do item 12-. Opcionalmente para otimitizar o processo acima em uma VM, abra no navegador o site do github e pesquise pelos  termos "desktop token a3" e copie e cole no terminal o texto abaixo para executar os processos acima de forma automatizada:
